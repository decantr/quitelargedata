...
Determine which, if any, of the Xj have an association with Y .
Identify the ’best’ subset of predictors from X1, X2, . . . , Xk .
Determine the goodness of fit of the selected model.
Interpret the coefficient estimates.
Determine the accuracy of estimated effects (coefficient
estimates).
Compute and determine the accuracy of predictions of Y for a
set of observations on the explanatory variables, Xj
, included
in the model.
...
<<>>=
plot(df$cap.color,df$cap.shape)
